                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{route('products.index')}}"
                                class="nav-link {{ request()->routeIs('products.index') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('categories.index')}}"
                                class="nav-link {{ request()->routeIs('categories.index') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('sales.index')}}"
                                class="nav-link {{ request()->routeIs('sales.index') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('notifications.index')}}"
                                class="nav-link {{ request()->routeIs('notifications.index') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('accounts.index')}}"
                                class="nav-link {{ request()->routeIs('accounts.index') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href=""
                                class="nav-link {{ request()->routeIs('') ? 'active bg-dark text-light' : '' }}">
                        ...
                        <li class="nav-item">
                            ...
                            @endphp
                            <a href="{{ route('change-password', $guard) }}"
                                class="nav-link {{ request()->routeIs('change-password') ? 'active bg-dark text-light' : '' }}">
