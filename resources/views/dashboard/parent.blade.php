        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ request()->routeIs('products.index') ? 'active bg-primary text-dark' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ request()->routeIs('categories.index') ? 'active bg-primary text-dark' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ request()->routeIs('sales.index') ? 'active bg-primary text-dark' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ request()->routeIs('notifications.index') ? 'active bg-primary text-dark' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ request()->routeIs('accounts.index') ? 'active bg-primary text-dark' : '' }}">
